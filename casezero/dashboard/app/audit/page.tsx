    ...
    <AppShell>
      ...
      <div className="detail-grid section">
        ...
        <aside className="panel panel-pad">
          ...
          <button className={`btn ${tampered ? "primary" : "danger"}`} type="button" aria-pressed={tampered} onClick={() => setTampered((value) => !value)}>{tampered ? "Restore verified view" : "Tamper sequence 04"}</button>
