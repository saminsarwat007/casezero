...
type Tracker = { case_ref: string; status: string; category?: string; urgency?: string; sla_due?: string; outcome?: string; amount_rm?: number; timeline: Array<{ event_type: string }>; bank_name: string; contact: string };
const rehearsal: Tracker = { case_ref: "MYB-2026-000012", status: "COMMUNICATED", category: "unauthorized_transaction", urgency: "High", sla_due: "2026-08-05T09:15:00+08:00", outcome: "RESOLVED_IN_FULL", amount_rm: 890, timeline: [{ event_type: "CASE_RECEIVED" }, { event_type: "CLASSIFIED" }, { event_type: "VERIFICATION_COMPLETED" }, { event_type: "JOURNAL_POSTED" }, { event_type: "MESSAGE_SENT" }], bank_name: "Demonstration Bank", contact: "help@demo.casezero.my" };
