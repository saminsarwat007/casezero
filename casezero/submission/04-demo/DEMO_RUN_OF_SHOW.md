...
This is a five-minute, deck-led story built around a live visitor-written complaint. Slides 1–13 are timed; slides 14–18 are appendix/Q&A only. Use the **33.76-second silent product film** only if venue connectivity prevents the live `/live` route from running.
...
| 1:35–2:05 | 6 — six agents | Name each specialist, what it does and whether it uses Gemini, Groq or no model. | AI Interaction; Technical Execution |
...
| 4:50–5:00 | 13 — the ask | Ask for a staff-reviewed pilot for unauthorised transactions and billing errors. Stop after: “Models propose. Rules decide. Humans own exceptions.” | Feasibility; Demo & Storytelling |
...
- `Axiom-Demo-Day-Deck.pptx` — 18-slide editable deck with notes on every slide.
- `Axiom-Demo-Day-Deck.pdf` — visually verified 18-page font-independent fallback.
