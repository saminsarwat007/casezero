...
description: >
  ...
  are identical and sacred — the green/pink/cream editorial triad, Instrument Sans at weight 500
...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "Instrument Sans", cqw: 1.56, weight: 400, lineHeight: 1.38 }
  body-card:{ fontFamily: "Instrument Sans", cqw: 1.35, weight: 400, lineHeight: 1.34 }
  label:   { fontFamily: "Martian Mono", px: 26, cqw: 1.35, weight: 580, tracking: "0.18em", upper: true }
  caption-mono:{ fontFamily: "Martian Mono", px: 24, cqw: 1.25, weight: 580, tracking: "0.14em", upper: true }
  # — display ramp (Instrument Sans weight 500, opsz, negative tracking) —
  title-card-sm:{ fontFamily: "Instrument Sans", cqw: 2.9, weight: 580, lineHeight: 0.98, tracking: "-0.01em" }
  title-card:{ fontFamily: "Instrument Sans", cqw: 3.5, weight: 580, lineHeight: 0.96, tracking: "-0.01em" }
  headline:{ fontFamily: "Instrument Sans", cqw: 4.4, weight: 580, lineHeight: 1.0, tracking: "-0.02em" }
  headline-xl:{ fontFamily: "Instrument Sans", cqw: 5.0, weight: 580, lineHeight: 0.96, tracking: "-0.02em" }
  display:{ fontFamily: "Instrument Sans", cqw: 7.3, weight: 580, lineHeight: 1.02, tracking: "-0.02em" }
  display-hero:{ fontFamily: "Instrument Sans", cqw: 11.5, weight: 580, lineHeight: 0.92, tracking: "-0.02em" }
  stat-figure:{ fontFamily: "Instrument Sans", cqw: 11.5, weight: 580, lineHeight: 0.92, tracking: "-0.03em" }
  stat-figure-unit:{ fontFamily: "Instrument Sans", cqw: 5.7, weight: 580, lineHeight: 0.92 }
  name:    { fontFamily: "Instrument Sans", cqw: 2.3, weight: 620, lineHeight: 1.0 }
...
components:
  topbar:
    typography: "{typography.label} (Martian Mono) + monogram-circle or counter"
...
- **Fonts** — already set to **Instrument Sans** (display) / **Martian Mono** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{400, 580, 620, 650, 700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
Penguin classic or a quiet annual report. One confident voice, **Instrument Sans at weight 500**
...
- **Instrument Sans weight 500** (opsz, negative tracking) for all display; **serif 400** body; **JetBrains Mono 500** uppercase chrome.
...
- **Squint** — one Instrument Sans moment dominates at 3–6× its neighbor; the surface block centers the eye.
...
Two ramps. The **reading/chrome ramp** (Instrument Sans **400** body 1.56cqw; JetBrains Mono labels
in px) carries copy + chrome; the **display ramp** (Instrument Sans **500** `title-card-sm` 2.9cqw →
...
- Run every display in **Instrument Sans weight 500**, opsz, negative-tracked, tight line-height; **body at 400**.
...
- **Type** — Instrument Sans **500** display (opsz, negative-tracked) / **400** body; mono uppercase 0.08–0.18em; ≥1.4cqw floor.
...
- **Instrument Sans (opsz 8..60) + JetBrains Mono via Google Fonts** — the optical-size axis is critical; a non-opsz fallback flattens the size-aware letterforms. CJK: LXGW WenKai (display) / Noto Serif SC (body) / Noto Sans Mono CJK (chrome).
